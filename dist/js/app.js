(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".instructors__body")) new core(".instructors__body", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
            ...
            if (document.querySelector(".our-center__img-block")) new core(".our-center__img-block", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".help__block-img")) new core(".help__block-img", {
            ...
            if (document.querySelector(".sanitary-norms__slider")) new core(".sanitary-norms__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                spaceBetween: 10,
            ...
            if (document.querySelector(".sanitary-norms__text")) new core(".sanitary-norms__text", {
            ...
            if (document.querySelector(".certificates__body")) new core(".certificates__body", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                spaceBetween: 30,
            ...
            if (document.querySelector(".our-specialist__body")) new core(".our-specialist__body", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
...
***************************************************************************** */
        ...
        function initYandexMap() {
            ...
            script.async = true;
            script.src = "https://api-maps.yandex.ru/services/constructor/1.0/js/?um=constructor%3A5fecc8558213ef1c470a415e1c71e613dee1782488d4fd6aa2b50ff2a4baeda1&amp;width=100%25&amp;height=600&amp;lang=ru_RU&amp;scroll=false";
        ...
        var dateInputMask = function dateInputMask(elm) {
            elm.addEventListener("keypress", (function(e) {
                ...
                if (1 !== len || 3 !== len) if (47 == e.keyCode) e.preventDefault();
                if (2 === len) elm.value += ".";
                if (5 === len) elm.value += ".";
            }));
        };
