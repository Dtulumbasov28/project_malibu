(() => {
  ...
  (() => {
            ...
            void 0 !== n &&
              ...
              (k(t[i]) && k(r[i])
                ? r[i].__swiper__
                  ...
                  : O(t[i], r[i])
                : !k(t[i]) && k(r[i])
                ? ((t[i] = {}), r[i].__swiper__ ? (t[i] = r[i]) : O(t[i], r[i]))
                : (t[i] = r[i]));
          }
        }
      }
        ...
        if (
          ...
          if (0 === t) a[e ? "scrollLeft" : "scrollTop"] = -c;
            ...
            if (!r.support.smoothScroll)
              return (
                P({ swiper: r, targetPosition: -c, side: e ? "left" : "top" }),
                !0
              );
    ...
    function R(e) {
      ...
      c && l.target && l.target.shadowRoot && u && (d = T(u[0]));
    ...
    function he({ swiper: e, extendParams: t, on: s, emit: i }) {
      ...
      function d() {
        ...
        if (
          ("fraction" === s.type &&
            (d.find(pe(s.currentClass)).text(s.formatFractionCurrent(c + 1)),
            d.find(pe(s.totalClass)).text(s.formatFractionTotal(u))),
          "progressbar" === s.type)
        ) {
          let t;
      ...
      function c() {
        ...
        if ("bullets" === t.type) {
          ...
          n.html(r), (e.pagination.bullets = n.find(pe(t.bulletClass)));
        }
        "fraction" === t.type &&
          ((r = t.renderFraction
      ...
      function u() {
        ...
        0 !== s.length &&
          ...
          t.clickable &&
            s.on("click", pe(t.bulletClass), function (t) {
              t.preventDefault();
      ...
      function p() {
        ...
        s.removeClass(t.hiddenClass),
          ...
          t.clickable && s.off("click", pe(t.bulletClass));
      }
      s("init", () => {
    ...
    window.addEventListener("load", function (e) {
      document.querySelector(".instructors__body") &&
        new de(".instructors__body", {
          modules: [ue],
          observer: !0,
          observeParents: !0,
          slidesPerView: "auto",
          ...
          breakpoints: { 320: { enabled: !0 }, 992: { enabled: !1 } },
          on: {},
        }),
        document.querySelector(".our-center__img-block") &&
          new de(".our-center__img-block", {
            modules: [ue],
            observer: !0,
            observeParents: !0,
            slidesPerView: 1,
        ...
        document.querySelector(".promotions__slider") &&
          new de(".promotions__slider", {
            modules: [he, ue],
            observer: !0,
            observeParents: !0,
            slidesPerView: 1,
            spaceBetween: 60,
            speed: 800,
            pagination: { el: ".swiper-pagination__promotions", clickable: !0 },
            navigation: {
        ...
        document.querySelector(".reviews__body") &&
          new de(".reviews__body", {
            modules: [he],
            observer: !0,
            observeParents: !0,
            slidesPerView: 1,
            ...
            breakpoints: { 320: { enabled: !0 }, 768: { enabled: !1 } },
            on: {},
          }),
        document.querySelector(".help__block-img") &&
          new de(".help__block-img", {
            modules: [ue, he],
            observer: !0,
            observeParents: !0,
            slidesPerView: 1,
        ...
        document.querySelector(".sanitary-norms__slider") &&
          new de(".sanitary-norms__slider", {
            ...
            breakpoints: { 0: { slidesPerView: 1 }, 600: { slidesPerView: 3 } },
            on: {},
          }),
        ...
        document.querySelector(".certificates__body") &&
          new de(".certificates__body", {
            modules: [he],
            observer: !0,
            observeParents: !0,
            spaceBetween: 30,
        ...
        document.querySelector(".our-specialist__body") &&
          new de(".our-specialist__body", {
            modules: [ue],
            observer: !0,
            observeParents: !0,
            slidesPerView: "auto",
...
***************************************************************************** */
        ...
        return (
          ...
          (e.prototype.loadContent = function (e, t) {
            ...
            if (
              ...
              if (m) {
                ...
                S = Xe(r, E || "", g, this.settings.strings.playVideo, h);
                n.prepend(S);
              } else if (h) {
              ...
              this.$inner.on("touchend.lg", function (r) {
                if ("swipe" === e.touchAction) {
                  if (i) (i = !1), e.touchEnd(s, t, r);
                    ...
                    var o = He(r.target);
                    e.isPosterElement(o) && e.LGel.trigger(ke);
                  }
          ...
          (e.prototype.destroyGallery = function () {
            this.destroyModules(!0),
              this.settings.dynamic || this.invalidateItems(),
              He(window).off(".lg.global" + this.lgId),
              this.LGel.off(".lg"),
    ...
    (it.prototype.init = function () {
      ...
      (it.prototype.mediaHandler = function (e, t) {
        if (e.matches)
      ...
      (it.prototype.moveTo = function (e, t, s) {
      ...
      (it.prototype.moveBack = function (e, t, s) {
        t.classList.remove(this.daClassname),
          void 0 !== e.children[s]
            ? e.children[s].insertAdjacentElement("beforebegin", t)
            : e.insertAdjacentElement("beforeend", t);
      }),
      (it.prototype.indexInParent = function (e, t) {
        const s = Array.prototype.slice.call(e.children);
        return Array.prototype.indexOf.call(s, t);
      }),
      (it.prototype.arraySort = function (e) {
        "min" === this.type
    ...
    function nt(e) {
      rt(), e.currentTarget.removeEventListener(e.type, nt);
    }
    function rt() {
    ...
    new it("max").init(),
      ...
      document.addEventListener("scroll", nt),
      document.addEventListener("mousemove", nt),
      document.addEventListener("touchstart", nt),
      window.addEventListener("DOMContentLoaded", function () {
        [].forEach.call(document.querySelectorAll(".input-tel"), function (e) {
          var t;
          function s(e) {
    ...
    var ot,
      at = document.querySelectorAll(".popup-input-date")[0];
    function lt(e, t) {
      const s = document.getElementById(e);
      if (!s) return !1;
      const i = s.querySelector(".clockdiv__days"),
        n = s.querySelector(".clockdiv__hours"),
        r = s.querySelector(".clockdiv__minutes"),
        o = s.querySelector(".clockdiv__seconds");
      function a() {
        const e = (function (e) {
    ...
    (ot = at).addEventListener("keypress", function (e) {
      (e.keyCode < 47 || e.keyCode > 57) && e.preventDefault();
      var t = ot.value.length;
      (1 === t && 3 === t) || (47 == e.keyCode && e.preventDefault()),
        2 === t && (ot.value += "."),
        5 === t && (ot.value += ".");
    });
    lt("clockdiv1", "December 31 2022");
    lt("clockdiv2", "December 11 2022"),
      (window.FLS = !0),
      (function (e) {
        let t = new Image();
        (t.onload = t.onerror =
              ...
              e.target.closest("[data-spollers]") ||
                c.forEach((e) => {
                  ...
                  if (t.classList.contains("_spoller-init")) {
                    const s = t.dataset.spollersSpeed
        ...
        async function s(e, t) {
          if (0 === (e.hasAttribute("data-no-validate") ? 0 : u.getErrors(e))) {
            if (e.hasAttribute("data-ajax")) {
              ...
              const o = await fetch(s, { method: n, body: r });
              if (o.ok) {
                let t = await o.json();
